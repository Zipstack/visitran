...
class TestFormulaSQLMath:
    ...
    def test_max(self):
        countries_x = self.countries.mutate(ibis.literal('2024-02-02', type="date").name('date_1')).mutate(ibis.literal('2024-02-03', type="date").name('date_2'))
        ...
        countries_y = self.countries.mutate(ibis.literal(None, type="date").name('date_1')).mutate(ibis.literal('2024-02-03', type="date").name('date_2'))
