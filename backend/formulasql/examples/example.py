...
if __name__ == '__main__':
    ...
    formula = FormulaSQL(countries, 'full_name',
                         '=IFS(continent="AS","Asia",continent="EU","Europe",continent="NA","North America")')
    countries = countries.mutate(formula.ibis_column())
    ...
    formula = FormulaSQL(countries, 'month_name',
    ...
    formula = FormulaSQL(countries, 'full_name2',
                         '=IFS(continent="AS","Asia",continent="EUX","Europe",continent="NA","North America")')
    countries = countries.mutate(formula.ibis_column())
