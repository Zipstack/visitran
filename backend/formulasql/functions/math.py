...
class Math(Base):
    ...
    def difference(table, node, data_types, inter_exps):
        ...
        # Case 4: Date - Timestamp (mixed types)
            ...
            (isinstance(col1_type, IbisDataType.DATE) and isinstance(col2_type, IbisDataType.TIMESTAMP))
            or isinstance(col1_type, IbisDataType.TIMESTAMP)
            and isinstance(col2_type, IbisDataType.DATE)
        ):
