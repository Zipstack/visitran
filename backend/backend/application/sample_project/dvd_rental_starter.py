...
class DvdRentalProjectStarter(SampleProject):
    ...
    def master_db_name(self):
        return "dvd_rental_starter_master"
    ...
    def database_name(self) -> str:
        return self.sanitize_name(f"{self.org_id}_{self._user_id}_dvd_db_s_{self.timestamp_str}")

    @property
    def user_name(self) -> str:
        return f"dbuser_{self.org_id}_{self._user_id}_dvd_s"[:63]
