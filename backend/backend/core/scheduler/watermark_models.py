...
class WatermarkHistory(DefaultOrganizationMixin, BaseModel):
    ...
    records_processed = models.IntegerField(default=0, help_text="Number of records processed in this run")

    execution_duration_seconds = models.FloatField(
        blank=True, null=True, help_text="Time taken for this incremental run"
    )

    strategy_used = models.CharField(max_length=20, help_text="Watermark strategy used for this execution")
