...
On OSS, returns a default value of 1 (no billing).
On Cloud, pluggable_apps.subscriptions.billing provides the real implementation
...
try:
    ...
    def calculate_chat_tokens(*args, **kwargs) -> int:  # noqa: ARG001
